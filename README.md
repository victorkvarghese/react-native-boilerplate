...
and redux persist. Latest version of react-navigation (v2.13) with NavigationService. Redux Integration deprecated/removed from react-navigation in the latest code.
